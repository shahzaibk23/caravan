 ...
 */
abstract class AbstrRequest extends MultiIOModule {
...
abstract class AbstrResponse extends MultiIOModule {
...
class BusHost extends MultiIOModule
class BusDevice extends MultiIOModule
...
abstract class DeviceAdapter extends MultiIOModule
abstract class HostAdapter extends MultiIOModule
